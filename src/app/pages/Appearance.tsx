...
export const applyAppearanceSettings = (settings: AppearanceSettings) => {
  ...
  root.dataset.daytrackTheme = settings.selectedTheme;
  root.dataset.daytrackCompact = String(settings.compactMode);
  document.body.style.backgroundColor = settings.selectedTheme === 'dark' ? '#111827' : '#ffffff';
};
...
export function Appearance() {
  ...
  return (
    <PageContainer className={`bg-gradient-to-b ${pageTheme}`} showSettings={false}>
      <div className="sticky top-0 bg-white/80 backdrop-blur-lg z-10 px-6 py-6 border-b border-gray-100">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl text-gray-800">Giao diện</h1>
      ...
      <div className="px-6 py-6 space-y-6">
        <section>
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-medium text-gray-800">Chọn chủ đề</h3>
            <button
        ...
        <section>
          <h3 className="text-lg font-medium text-gray-800 mb-4">Màu nhấn</h3>
        ...
        <section>
          <h3 className="text-lg font-medium text-gray-800 mb-4">Font & giao diện</h3>
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
              <div className="flex items-center justify-between mb-3">
                <span className="text-gray-700">Độ bo góc</span>
        ...
        <section>
          <h3 className="text-lg font-medium text-gray-800 mb-4">Tùy chọn bố cục</h3>
          <div className="bg-white rounded-2xl p-4 shadow-sm border border-gray-100">
            <div className="flex items-center justify-between">
              <div>
                <h4 className="font-medium text-gray-800">Chế độ gọn</h4>
                <p className="text-xs text-gray-500 mt-0.5">Giảm khoảng cách để có thêm nội dung</p>
              </div>
              <button
        ...
        <section>
          <h3 className="text-lg font-medium text-gray-800 mb-4">Xem trước</h3>
          <div className="bg-gradient-to-br from-blue-100 to-purple-100 rounded-3xl p-6">
            <div
              className={`bg-white shadow-sm ${settings.compactMode ? 'p-3 mb-2' : 'p-4 mb-3'}`}
              style={{ borderRadius: `${settings.cornerRadius}px` }}
            >
              <h4 className="font-medium text-gray-800" style={{ fontSize: `${settings.fontSize}px` }}>
                Văn bản mẫu
              </h4>
              <p className="text-sm text-gray-600 mt-1">Đây là cách ứng dụng của bạn sẽ trông như thế nào</p>
            </div>
            <div
